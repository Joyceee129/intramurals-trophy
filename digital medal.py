...
OUT_FILENAME = "CSCOMSCIE3_3B_BayudJoyceAnn_Activity1.png"
...
draw_text_on_arc(img, (cx, cy), outer_r-90, "MOST CREATIVE", font, 160, 20, fill=(40,30,20))

# bottom arc text (mirrored below)
draw_text_on_arc(img, (cx, cy), outer_r-60, "CHANT • INTRAMURALS", font, -20, -160, fill=(40,30,20))
